...
local Window = OrionLib:MakeWindow({Name = "Ducsharelink Hub", HidePremium = false, IntroText = "Ducsharelink Hub", SaveConfig = true, ConfigFolder = "ConfigSetting"})

OrionLib:MakeNotification({
	Name = "Script Say!",
	Content = "Please Wait loading script...",
	Image = "rbxassetid://18861408627",
	Time = 5
})

local W = Window:MakeTab({
	Name = "Welcome",
	Icon = "rbxassetid://18861408627",
	PremiumOnly = false
})
